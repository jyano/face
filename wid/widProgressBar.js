...
$.wg("cust.prgbar", {
	options: {v: 0},
	_create: function () {
		this.element.K("prgbar").text(this.options.v + "%")
	},
...
$.wg("jy.bar", {
	options: {v: 0},
	_create: function () {this.element.K("bar").text(this.options.v + "%")
				this._update()},
		
	_constrain: function (v) {return v > 100 ? 100 : v < 0 ? 0 : v},
	
	_setOption: function (key, v) {this.options[key] = v;this._update()},
